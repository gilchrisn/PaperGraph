...
def save_progress(last_processed, current_reference, reference_list):
    ...
    with open("progress_checkpoint.txt", "w") as checkpoint:
        checkpoint.write(f"{last_processed}\n{current_reference}\n")
    with open("reference_list_checkpoint.txt", "w") as ref_list_file:
        ref_list_file.write("\n".join(reference_list))
...
def load_progress():
    ...
    if os.path.exists("progress_checkpoint.txt"):
        with open("progress_checkpoint.txt", "r") as checkpoint:
    ...
    reference_list = []
    if os.path.exists("reference_list_checkpoint.txt"):
        with open("reference_list_checkpoint.txt", "r") as ref_list_file:
